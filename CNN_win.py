...
if __name__ == '__main__':
    ...
    val_acc_list = []
    noise_factor_list = []
    f = open(r'C:\Users\wangbc1\Desktop\OCR\model\准确率纪录.txt','w')
    ...
    for epoch in range(n_epoch):
        ...
        print("   noise factor %d: %f" % (epoch + 1, (nf / (128 * n_batch))))
        print('\n')
        ...
        if val_acc / n_batch > max_acc:
            ...
            saver.save(sess, r'C:\Users\wangbc1\Desktop\OCR\model\CNN-Model', global_step=epoch + 1)
