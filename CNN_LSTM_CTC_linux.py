...
# 读入图像，会将样本和标签打乱顺序返回
def read_img():
    with open('/home/wangbc1/OCR/SynthText_Chinese_version-master/SynthText_Chinese_version-master/results/image/label.txt','r') as f:
        num = 1
        a = f.readlines()
        imgs = []
        labels = []
        ...
        for i in range(len(a)):
            img = cv2.imread('/home/wangbc1/OCR/SynthText_Chinese_version-master/SynthText_Chinese_version-master/results/image/'+a[i].split()[0])
            try:
...
if __name__ == '__main__':
    ...
    seqlength = np.load('/home/wangbc1/OCR/data/seqlength2.npy')
