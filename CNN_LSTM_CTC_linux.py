...
def read_img():
    ...
    path = '/home/wangbc1/OCR/SynthText_Chinese_version-master/SynthText_Chinese_version-master/results/newimage'
    ...
    seqlength = np.asarray(seqlengths,np.int32)
...
if __name__ == '__main__':
    ...
    print ('Loading Image ......')
    data = np.load('/home/wangbc1/OCR/data/data4.npy')
    label = np.load('/home/wangbc1/OCR/data/label4.npy')
    seqlength = np.load('/home/wangbc1/OCR/data/seqlength4.npy')
    ...
    for epoch in range(n_epoch):
        ...
        print ("   time %f" % (middle_time-start_time))
        ...
        print("   time %f" % (end_time - middle_time))
        print ('\n')
        print('##############################################################################')
