...
DATA_PATH = '/home/wangbc1/OCR/SynthText_Chinese_version-master/SynthText_Chinese_version-master/data'
DB_FNAME = osp.join(DATA_PATH,'dset_8000.h5')
# url of the data (google-drive public file):
DATA_URL = 'http://www.robots.ox.ac.uk/~ankush/data.tar.gz'
OUT_FILE = '/home/wangbc1/OCR/SynthText_Chinese_version-master/SynthText_Chinese_version-master/results/SynthText_8000_'
...
def main(num,viz=False):
  ...
  out_db = h5py.File(OUT_FILE+'%d.h5' % (num),'a')
  out_db.create_group('/data')
  print colorize(Color.GREEN,'Storing the output in: '+OUT_FILE+'%d.h5' % (num), bold=True)
